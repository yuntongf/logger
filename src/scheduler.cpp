...
Scheduler::ScheduledTask::TaskId Scheduler::postRepeatedTask(ThreadPool::Task task, std::chrono::duration<T, R> period, bool repeated) {
...
template <typename T, typename R>
Scheduler::ScheduledTask::TaskId postDelayedTask(ThreadPool::Task task, std::chrono::duration<T, R> period) {
